...
OptiXModel::OptiXModel(OptiXModel *_instance){
    ...
    //mat->setClosestHitoptix::Program(0,_instance->m_geometryInstance->getMaterial(0)->getClosestHitoptix::Program(0));
    //mat->setAnyHitoptix::Program(1,_instance->m_geometryInstance->getMaterial(0)->getAnyHitoptix::Program(1));
    setMaterial(mat);
...
void OptiXModel::createBuffers(){
    ...
    //create and set our intersection and bound optix::Programs
    optix::Program interProg = PathTracerScene::getInstance()->getContext()->createProgramFromPTXFile("ptx/triangle_mesh.cu.ptx","mesh_intersect");
    optix::Program boundProg = PathTracerScene::getInstance()->getContext()->createProgramFromPTXFile("ptx/triangle_mesh.cu.ptx","mesh_bounds");
...
//                                     vertIdices );
    ...
    //create our acceleration method, in this case none becuase we only have one peice of geomtry
    optix::Acceleration acceleration = PathTracerScene::getInstance()->getContext()->createAcceleration("Sbvh","Bvh");
    //set this acceleration in our geometry group
